    ...
    <div>
      ...
      <section className="dark:bg-gray-100 dark:text-white">
        <div className="container bg-black flex flex-col lg:flex-row justify-between p-6 mx-auto">
          ...
          <div className="flex flex-col justify-start p-10 text-center lg:max-w-md xl:max-w-lg lg:text-left w-full lg:w-1/2 fade-in" style={{ animationDelay: "0.5s" }}>
      ...
      <section>
        <div className="bg-gray-200">
          <div className="p-5 italic font-extralight px-36 text-[45px]">
            <h1><span className="text-[#f86a04]">The Impact</span><br/>
            We Have Made</h1>
          </div>
