            ...
            >
              ...
              <div>
                <select
                  ...
                  name="option"
                  required
                  className="w-full p-3 bg-gray-200 border border-primary rounded text-black focus:border-primary focus:ring-2 focus:ring-primary outline-none transition-all duration-200"
