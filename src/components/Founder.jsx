        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
          ...
          <div className="flex flex-col items-center text-center md:text-left md:flex-row bg-white shadow-lg rounded-lg p-6 space-y-4">
            <img
              src={Founders}
              alt="Founder"
              className="w-56 h-full  object-cover mb-4 md:mb-0"
            />
            <div className="md:ml-6">
              ...
              <p className="text-black italic mt-2 text-justify">
                ...
                while her younger son, a cybersecurity expert, serves as the CTO. With her exceptional leadership skills and unwavering determination,
                Mrs. Revathi T continues to be a source of motivation and empowerment for the team at KAR International Infotech.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center md:text-left md:flex-row bg-white shadow-lg rounded-lg p-6 space-y-4">
            ...
            <div className="md:ml-6">
              ...
              <p className="text-black italic mt-2 text-justify">
                As the CEO of KAR International Infotech, Karthikeyan leads the company with a vision for innovation and excellence in the digital world.
                With expertise in business development, web technologies, and digital marketing, he has played a key role in scaling the company’s success.
              </p>
              <p className="text-black italic mt-2 text-justify">
                Under his leadership, KAR International Infotech has delivered cutting-edge web solutions, custom software, and result-driven digital marketing strategies.
                His passion for technology and business growth drives the company to new heights.
              </p>
            </div>
          </div>
        </div>
