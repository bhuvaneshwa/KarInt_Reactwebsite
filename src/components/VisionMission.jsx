...
export default function VisionMission() {
    return (
      <div className="relative bg-gray-100 py-16 flex flex-col items-center">
        {/* Background Gray Box */}
        <div className="absolute bg-gray-300 w-3/4 h-3/4 top-1/2 right-0 transform -translate-y-1/2 translate-x-1/4 z-0"></div>
        
        {/* Who We Are Card */}
        <div className="bg-black text-white p-8 max-w-7xl mt-8 z-10">
        ...
        {/* Vision, Mission, and Who We Are Cards */}
        <div className="relative flex flex-col md:flex-row justify-center items-center gap-10 pt-8 z-10">
          <div className="bg-black text-white p-8 max-w-sm mt-8 md:mt-0">
