      ...
      <div className="max-w-4xl mx-auto text-center md:text-left">
        <div className="flex flex-col md:flex-row items-center md:justify-around gap-10">
          ...
          <div className="flex items-center w-full md:w-auto">
            ...
            />
            <button
              onClick={handleSubscribeClick} // Redirect and scroll to top
              className="bg-black text-white px-6 py-3 font-semibold hover:bg-gray-900 transition duration-200"
            >
              Subscribe
            </button>
          </div>
